...
namespace CarBook.Application.Features.Mediator.Handlers.StatisticsHandlers
{
    public class GetAvgRentPriceDailyQueryHandler : IRequestHandler<GetAvgRentPriceDailyQuery, GetAvgRentPriceDailyQueryResult>
    {
        ...
        public GetAvgRentPriceDailyQueryHandler(IStatisticRepository statisticRepository)
        {
        ...
        {
            var value = _statisticRepository.GetAvgRentPriceDaily();
            return new GetAvgRentPriceDailyQueryResult
            {
                AvgPriceDaily = value
            };
        }
